...
Download the dataset from [this link](https://drive.google.com/file/d/19aI15c13zJ6RzQsOs-JL-JhJ1H67IRfD/view?usp=drive_link), extract it, and place `data.csv` in the `data` folder.
